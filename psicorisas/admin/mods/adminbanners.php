					...
					if($_GET['subopcion']=="agregar"){
						...
						if($pedidolog){
							...
							if($filaslog==0){
								...
								$sql2="INSERT INTO banner(seccion,tipobanner,patrocinante,imgbanner,objeto,enlace) VALUES('$seccionpagina','$tipobanner','$patrocinante','$destino','$objeto','$enlacebanners')";
								//PEDIDO CONSULTA
				...
				<tr>
					<td>
						<SELECT name="tipobjeto" id="tipobjeto">
							...
							<OPTION <?php if($objetocons=='FLASH'){ echo("SELECTED"); } ?> >VIDEO YOUTUBE</OPTION>
						</SELECT>
					</td>
				</tr>
				<tr>
