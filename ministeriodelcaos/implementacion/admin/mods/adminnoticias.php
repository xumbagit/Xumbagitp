...
<?php
						...
						<SELECT name="tiponota" id="tiponota">
							<OPTION <?php if($tiponota=="GALERIA"){ echo("SELECTED"); } ?> value="GALERIA">GALERIA</OPTION>
							<OPTION <?php if($tiponota=="VANCE_SUZETTE"){ echo("SELECTED"); } ?> value="VANCE_SUZETTE">VANCE_SUZETTE</OPTION>
							<OPTION <?php if($tiponota=="LEGADO"){ echo("SELECTED"); } ?> value="LEGADO">LEGADO</OPTION>
						</SELECT>
					</td>
				</tr>
				<tr>
