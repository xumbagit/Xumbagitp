...
<html>
	...
	<script type="text/javascript" src="libs/jquery-ui/js/jquery-ui-1.10.4.custom.js"></script>
	<link rel="stylesheet" href="/libs/jquery-ui/css/ui-lightness/jquery-ui-1.10.4.custom.css"/>
    </head>
    <body>
		    ...
		    <div class="navbar navbar-inverse navbar-fixed-top">
		      <div class="navbar-inner">
		        <div class="container-fluid">
		          ...
		          <a class="brand" href="#">elministerio.tv</a>
		          </div><!--/.nav-collapse -->
		        </div>
		      </div>
		    </div>
		      ...
		      <div class="navbar-inner">
		        <div class="container-fluid">
		          ...
		          <div class="nav-collapse collapse">
		            ...
		            <ul class="nav">
					  <li><a href="index.php?mod=adminnoticias&opcion=noticias&subopcion=agregar&entrar=">Eventos</a></li>
					  <li><a href="index.php?mod=adminbackground&opcion=background&subopcion=modificar&entrar=">Backgrounds</a></li>
					  <li><a href="index.php?mod=adminbotonera&opcion=botonera&subopcion=modificar&entrar=">Botonera</a></li>
					  <li><a href="index.php?mod=adminfrasecontacto&opcion=encabezado&subopcion=modificar&entrar=">Encabezados</a></li>
					  <li><a href="index.php?mod=admincontactos&opcion=contactos&subopcion=agregar&entrar=">Familia</a></li>
					  <li><a href="index.php?mod=adminfrase&opcion=frase&subopcion=modificar&entrar=">Frase</a></li>
					  <li><a href="index.php?mod=adminpublicidad&opcion=publicidad&subopcion=modificar&entrar=">Publicidad</a></li>
					  <li><a href="index.php?mod=adminpublicidad&opcion=textos&subopcion=modificar&entrar=">Textos</a></li>
		            </ul>
		          </div><!--/.nav-collapse -->
		        </div>
		      </div>
