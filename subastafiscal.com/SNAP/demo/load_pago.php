...
if(isset($_GET['tipo_pago']))
{
	if($_GET['tipo_pago'] == 1)
	{
		echo "<label class='textformulario'>Número de Depósito: </label>";
		echo "<input name='num_deposito' id='num_deposito' type='text' size='40' class='relleno1' /><br /><br />";
		echo "<label for='fecha' class='textformulario'>Fecha</label>
              <input id='fecha'>";
		echo "<br/><br/>";
		echo "<input type='submit' value='pagar' class='botoninputbalance1' />";
	}else if($_GET['tipo_pago'] == 2){
		echo "<label class='textformulario'>Número de Transferencia: </label>";
		echo "<input name='num_transf' id='num_transf' type='text' size='40' class='relleno' />";
		echo "<br/><br/>";
		echo "<input type='submit' value='pagar' class='botoninputbalance1' />";
	}else if($_GET['tipo_pago'] == 3){
		echo "<br/><br/>";
		echo "<input type='submit' value='pagar' class='botoninputbalance1' />";
	}else if($_GET['tipo_pago'] == ""){
		echo "";
	}

	echo "<div id='dudas'>Tienes dudas? ingresa a la sección de <span class='links'><a href='#'>Preguntas Frecuentes</a></span></div>";
}
