    ...
    <div id="sombra"></div>
       ...
       <li class="botonesusuario"><a href="index.php?webpage=15&amp;seccpnt=2"><span class="icon3"></span>Balance y Certif.</a></li>
        ...
        <? } ?>
        	...
        	<div id="logo"><img src="img/logo.png" width="248" height="192" border="0"  onclick="document.location.href='index.php';" style="cursor:pointer;"/>
            </div>
            	<div id="blanco">
                </div>
                	<div id="menu">
                      ...
                      <div class="filo"><img src="img/filo.png" width="3" height="54" border="0" /></div>
                                     ...
                                     <div class="filo"><img src="img/filo.png" width="3" height="54" border="0" /></div>
                                       <li class="botongrande"><a href="index.php?webpage=9"><span class="botonesgrande">Actualidad</span>
                                    <br /><span class="botonesgrande">Fiscal</span></a></li>
                                      <div class="filo"><img src="img/filo.png" width="3" height="54" border="0" /></div>
                        ...
                        <div id="columna3">
                         ...
                         <div class="separacion"></div>
                        	 <div id="columna4">
                              ...
                              <div id="columna5">
                         		<div class="contenedorlinks">
    								<div id="inicio"><a href="index.php?webpage=9">Actualidad Fiscal</a></div>
                               </div>
                               		</div>
                                    <div class="separacion"></div>
                                    <div id="columna6">
