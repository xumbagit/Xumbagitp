...
class db{
	...
	*/
		...
		switch ($this->vardb){
			case "sybase":
				...
				if ($GLOBALS['conid']>0){
					...
					if ($a<1){
						echo "No se encontró la base de datos ".$dbName." en el servidor.";
					}
					//echo $a;
				}else{
					echo "Problemas al conectar con el servidor de datos... verifique la conexión a '".$par_host."'";
			...
			case "mysql":
				...
				if ($GLOBALS['conid']>0){
					...
					die ("Problemas al conectar con el servidor de datos... verifique la conexión a '".$par_host."'");
				}
				return $this->conid;
				
			default:
				echo "Error al intentar ejecutar conexión, se debe 
	...
	/* 
		Funcion generica para seleccionar bd a través de 
		  manejador de conexión
		Parametros:
			$par_name = Nombre de la bd a seleccionar
			$par_con  = Manejador de conexión actual
	...
	*/
	...
	/* 
		Funcion generica para ejecutar un query a la
		  bd a través del manejador de conexión
		Parametros:
	...
	*/
	...
	/* 
		Funcion generica que finaliza una conección a la bd
		Parametros:
			$par_con   = Manejador de conexión actual
