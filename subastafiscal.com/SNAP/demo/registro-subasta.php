	...
	<div id="contenedorformulario">
    	<div id="pestana2">Venta de Crédito Fiscal
            ...
            <?
			   ...
			   $sql      = "SELECT origen, descripcion FROM df_origen";
			   $datasql  = fnc_ejecutaQuery($sql);
			   echo fncv_selectInput($valor,'domicilio','id="origenfield" accept="required" onchange="cambiaSelect(this.value,\'selecdocum\',5)"','origen',$datasql);
			?>
