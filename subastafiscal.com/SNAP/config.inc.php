 ...
 */
$cfg['PmaAbsoluteUri'] = 'http://www.subastafiscal.com/phpMyAdmin';
...
$cfg['Servers'][$i]['controlpass']   = 'Prog321';          // access to the "mysql/user"
                                                    // and "mysql/db" tables).
...
$cfg['Servers'][$i]['password']      = 'Prog321';          // MySQL password (only needed
