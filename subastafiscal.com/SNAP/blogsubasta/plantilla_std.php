<?php
	...
	//////////////////////////////////////////////////////////////////
	if($_GET['categ']!=''){
		$condic2="WHERE idioma='es' AND tipo='".$_GET['categ']."' ORDER BY fechacons ASC";
	}
	elseif($_GET['buscarelementos']!=''){
		$condic2="WHERE titulo LIKE '%".$_GET['buscarelementos']."%' idioma='es' ORDER BY fechacons ASC";
	}
	elseif($_GET['eventos']=='true'){
		$condic2="WHERE tipo='EVENTO' AND destacado='SI' AND idioma='es' ORDER BY fechacons ASC";
	}
	else{
		$condic2="WHERE idioma='es' AND destacado<>'SI' AND tipo<>'EVENTO' ORDER BY fechacons ASC";
	}
	//PAGINACION
...
<?php
						...
						<div id="colderpq">
							...
							if($_GET['categ']!='' && $_GET['eventos']!='true'){
								$sql3="SELECT * FROM noticias WHERE idioma='es' AND destacado<>'SI' AND tipo='".$_GET['categ']."' ORDER BY fechacons ASC LIMIT ".$inicio.",".$TAMANO_COLUMNA;
							}
							elseif($_GET['buscarelementos']!=''){
								$sql3="SELECT * FROM noticias WHERE titulo LIKE '%".$_GET['buscarelementos']."%' AND destacado<>'SI' AND idioma='es' ORDER BY fechacons ASC LIMIT ".$inicio.",".$TAMANO_COLUMNA;
							}
							elseif($_GET['eventos']=='true'){
								$sql3="SELECT * FROM noticias WHERE tipo='EVENTO' AND destacado='SI' AND idioma='es' ORDER BY fechacons ASC LIMIT ".$inicio.",".$TAMANO_COLUMNA;
							}
							else{
								if($tiponoticia==''){
									$sql3="SELECT * FROM noticias WHERE idioma='es' AND destacado<>'SI'  ORDER BY fechacons ASC, ID DESC LIMIT ".$inicio.",".$TAMANO_COLUMNA;
								}
								else{
