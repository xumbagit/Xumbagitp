...
class db{
	...
	*/
	...
	/* 
		Funcion generica para seleccionar bd a trav�s de 
		  manejador de conexi�n
		Parametros:
			$par_name = Nombre de la bd a seleccionar
			$par_con  = Manejador de conexi�n actual
	...
	*/
	...
	/* 
		Funcion generica para ejecutar un query a la
		  bd a trav�s del manejador de conexi�n
		Parametros:
	...
	*/
	...
	/* 
		Funcion generica que finaliza una conecci�n a la bd
		Parametros:
			$par_con   = Manejador de conexi�n actual
