...
<?php
						...
						<SELECT name="tiponota" id="tiponota">
							...
							<OPTION <?php if($tiponota=="TRIBUTARIA"){ echo("SELECTED"); } ?> value="TRIBUTARIA">LEGAL</OPTION>
							...
							<OPTION <?php if($tiponota=="EVENTO"){ echo("SELECTED"); } ?> value="EVENTO">EVENTO</OPTION>
							<OPTION <?php if($tiponota=="MEDIOS"){ echo("SELECTED"); } ?> value="MEDIOS">SUBASTA EN MEDIOS</OPTION>
						</SELECT>
					</td>
				</tr>
				<tr>
