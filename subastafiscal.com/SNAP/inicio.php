...
<div id="container">
    <div id="slides">
	  <div class="slides_container">
	  				<div class="slide">
			        	<a href="http://subastafiscal.com/sf/web/blogsubasta/index.php?idnoticia=125" target="_blank">
			        		<img src="img/taller_sicad_tachira-web-02.jpg" width="590" height="305" alt="Presiona Click...y aprenderás a usar nuestro portal!" border="0"/>
			        	</a>
					</div>
                    <div class="slide">
					...
					while($datos2=mysql_fetch_array($query)){
						...
						?>
				          <tr class="fila_blanca">
				              <td><span class="casillas" id="vn0"><?php echo($datos2['valnominal']); ?></span></td>
				              <td><span class="casillas_origen" id="orig0"><?php echo($datos2['origen']); ?></span></td>
				              <td><span class="casillas_mpo" id="mpo0"><?php echo($datos2['MPO']); ?></span></td>
				              <td><span class="detalle" id="subDetalle0"><?php echo($datos2['detalles']); ?></span></td>
				          </tr>
						<?php
						}
						else{
						?>
				          <tr>
				              <td><span class="casillas" id="vn1"><?php echo($datos2['valnominal']); ?></span></td>
				              <td><span class="casillas_origen" id="orig1"><?php echo($datos2['origen']); ?></span></td>
				              <td><span class="casillas_mpo" id="mpo1"><?php echo($datos2['MPO']); ?></span></td>
				              <td><span class="detalle" id="subDetalle1"><?php echo($datos2['detalles']); ?></span></td>
				          </tr>
						<?php
						}
						$x++;
	...
	<div class="banner_home2">
    	<a href="http://subastafiscal.com/sf/web/blogsubasta/index.php?idnoticia=124" target="_blank"><img src="img/banner_cefincorp-01.png" width="940" height="100" border="0" /></a>
    </div>
