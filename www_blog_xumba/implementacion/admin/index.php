		    ...
		    <div class="navbar navbar-inverse navbar-fixed-top">
		      <div class="navbar-inner">
		        <div class="container-fluid">
		          ...
		          <a class="brand" href="#">Xumba Blog</a>
		          </div><!--/.nav-collapse -->
		        </div>
		      </div>
		    </div>
...
<?php
	...
	if($btnlog){
		...
		$sqlog="SELECT * FROM clientes WHERE email='$usuario' AND clave='$clave'";
		...
		if($pedidolog){
			...
			if($filaslog>0){
				...
				$_SESSION['usuarioreg']=$datoslog['email'];
				$_SESSION['idusuario']=$datoslog['ID'];
				$_SESSION['nombrereal']=strtoupper($datoslog['email']." ".$datoslog['apellido']);
