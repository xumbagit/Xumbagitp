...
<div id="container">
    <div id="slides">
	  <div class="slides_container">
                  	...
                  	<div class="slide">
                  		<a href="http://subastafiscal.com/sf/web/img/media_pagina_Nueva_Esparta_SICAD-01.png" target="_blank">
							<img src="img/banners_foro_sicad_fedecamaras_nva_esparta.png" width="590" height="305"  border="0"/>
                  		</a>
                    </div>
                  	<div class="slide">
                  		<a href="http://subastafiscal.com/sf/web/img/Afiche_XII_JORNADAS.jpg" target="_blank">
							<img src="img/islr_70_anos.jpg" width="590" height="305"  border="0"/>
                  		</a>
                    </div>                   
                    <div class="slide">
	...
	<div id="contenedor_noticias">
		<div id="pestana"><span id="boton-prev"><a href="#"><<</a></span><h6>Actualidad Fiscal</h6>
	     ...
	     <div class="modulos">
	    	<div id="titulo_noticia">D&oacute;lar Permuta</div>
	        <div id="fecha_noticia">10/09/2013</div>
	      	<div id="contenido_noticia">Fuentes aseguran el regreso del mercado permuta donde, en un pasado no muy lejano, contábamos con una válvula...</div>
	        <span class="boton_verde_i"><a href="index.php?webpage=23" target="_self">leer más</a></span>
	     </div>
	    <div class="modulos">
	    	<div id="titulo_noticia">Legitimaci&oacute;n de Capitales</div>
	        <div id="fecha_noticia">27/08/2013</div>
	      <div id="contenido_noticia">La definición para el público en general de este término pasa por una suerte de delito internacional...</div>
	        <span class="boton_verde_i"><a href="index.php?webpage=24" target="_self">leer más</a></span>
		</div>
	    <div class="modulos">
	    	<div id="titulo_noticia">Ley de Cultura</div>
	        <div id="fecha_noticia">20/08/2013</div>
	        <div id="contenido_noticia">En marzo de este año, analizamos el estudio que realizó la agencia de Doing Business Database, en el que se indica...</div>
	        <span class="boton_verde_i"><a href="index.php?webpage=25" target="_self">leer más</a></span>
		</div>
	</div>
