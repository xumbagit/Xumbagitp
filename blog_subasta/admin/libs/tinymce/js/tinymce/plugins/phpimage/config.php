...
$_cur_dir = getcwd(); if ($_cur_dir == FALSE) { $_cur_dir = $_SERVER['SERVER_NAME']."/"; }
...
$server_image_directory		= $_cur_dir.'img/';  //e.g. '/home/user/public_html/uploads'; 
// URL directory to stored images (relative or absoulte) - IMPORTANT CHANGE PATH TO SUIT YOUR NEEDS!!!
$url_image_directory			= 'img/'; 
