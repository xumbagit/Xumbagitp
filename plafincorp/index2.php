...
<script src="libs/colorbox/colorbox/jquery.colorbox.js"></script>
...
<div id="content">
  ...
  <div id="botoneracontenedor" style="margin: 0px auto;">
    	...
    	<div id="botonera">
			...
			<div name="imagenpopup" id="imagenpopup" style="display:none;">
    ...
    behavior: 'default'
       	...
       	<form method="GET" enctype="multipart/form-data">
            <div id="contenedorcontactos">
       		  <div id="contactenos" style="z-index: 8000;">
                    	<h1>CONTACTENOS</h1>
                    	<table>
                    		<tr>
                    			<td style="border:0;">
                    				<INPUT name="nombre" id="nombre" type="text" value="Nombre" style="width: 270px;" onclick="limpiar('nombre');" onblur="escribir('nombre','Nombre');">
                    			</td>
                    		</tr>
                    		<tr>
                    			<td style="border:0;">
                    				<INPUT name="apellido" id="apellido" type="text" value="Apellido" style="width: 270px;" onclick="limpiar('apellido');" onblur="escribir('apellido','Apellido');">
                    			</td>
                    		</tr>
                    		<tr>
                    			<td style="border:0;">
                    				<INPUT name="telefono" id="telefono" type="text" value="Telefono" style="width: 270px;" onclick="limpiar('telefono');" onblur="escribir('telefono','Telefono');">
                    			</td>
                    		</tr>
                    		<tr>
                    			<td style="border:0;">
                    				<INPUT name="email" id="email" type="text" value="Email" style="width: 270px;" onclick="limpiar('email');" onblur="escribir('email','Email');">
                    			</td>
                    		</tr>
                    		<tr>
                    			<td style="border:0;">
                    				<textarea name="mensaje" id="mensaje" style="width: 270px;" onclick="limpiar('mensaje');" onblur="escribir('mensaje','Mensaje');">Mensaje</textarea>
                    			</td>
                    		</tr>
                    	</table>
              </div>
              <div id="contactenosplanilla">
                    </div>
                     <div id="contactenosboton">
                   	   <div id="botongenral"><a href="index.php">Borrar</a>
                        </div>
                       <div id="botongenral"><a href="index.php?enviarform=true">Enviar</a>
                        </div>
                    </div>
            </div>
       		 </form>
        ...
        <div id="linealogos">
        		...
        		<div id="logos">
                    ...
                    <div id="logossolos">
                    	<a href="http://xumbadevenezuela.com/" target="_blank">
                    		<img src="imag/xumba.png" width="172" height="52"> 
                    	</a>
                    </div>
                </div>
			...
			<div id="footer">
			  <div id="footercontend">
                ...
                <div id="footercontend3" style="left: 178px;">
                </div>
                <div id="footercontend2" style="left: 190px;">
                	<p  style="font-family: Arial, Helvetica, sans-serif; color: white; font-weight: bolder;text-decoration: none;margin-top: 5px;">
                		<a href="index.php"  style="font-family: Arial, Helvetica, sans-serif; color: white; font-weight: bolder;text-decoration: none;">
							LA EMPRESA
                		</a>
                		<p  style="font-family: Arial, Helvetica, sans-serif; color: white;text-decoration: none;">
                			<a style="font-family: Arial, Helvetica, sans-serif; color: white; font-weight: bolder;text-decoration: none;" href="index.php?mod=empresa&sm=qsomos">
                				- Qui&eacute;nes Somos
                			</a>
                		</p>
                		<p style="font-family: Arial, Helvetica, sans-serif; color: white;text-decoration: none;">
                			<a style="font-family: Arial, Helvetica, sans-serif; color: white; font-weight: bolder;text-decoration: none;" href="index.php?mod=empresa&sm=directores">
                				- Directores
                			</a>
                		</p>
                	</p>
                ...
                <div id="footercontend2" style="left: 390px;">
                	<p style="font-family: Arial, Helvetica, sans-serif; color: white; font-weight: bolder;text-decoration: none;margin-top: 5px;">
                		...
                		<br>
                		<a href="index.php?mod=areasnegocios&sm=ic" style="font-family: Arial, Helvetica, sans-serif; color: white;text-decoration: none;">
							- Impuestos Corporativos
                		</a>
                		<br>
                		<a href="index.php?mod=areasnegocios&sm=ii" style="font-family: Arial, Helvetica, sans-serif; color: white;text-decoration: none;">
							- Impuestos Internacionales
                		</a>
                		<br>
                		<a href="index.php?mod=areasnegocios&sm=pt" style="font-family: Arial, Helvetica, sans-serif; color: white;text-decoration: none;">
							- Precios de Transferencia
                		</a>
                		<br>
                		<a href="index.php?mod=areasnegocios&sm=ot" style="font-family: Arial, Helvetica, sans-serif; color: white;text-decoration: none;">
							- Otros Tributos
                		</a>
                		<br>
                		<a href="index.php?mod=areasnegocios&sm=alt" style="font-family: Arial, Helvetica, sans-serif; color: white;text-decoration: none;">
